...
describe("lamb.object", function () {
    ...
    describe("mapValues / mapValuesWith", function () {
        ...
        it("should pass the key value, its name and the object being traversed to the mapping function", function () {
            var deductFiveSpy = jasmine.createSpy().and.callFake(function (v, k, o) {
                expect(o).toBe(foo);
                expect(o[k]).toBe(v);
            ...
            expect(lamb.mapValues(foo, deductFiveSpy)).toEqual(r);
            expect(lamb.mapValuesWith(deductFiveSpy)(foo)).toEqual(r);
        });
